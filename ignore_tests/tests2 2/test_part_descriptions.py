...
class TestPartDescriptions(unittest.TestCase):
    def setUp(self):
        ...
        self.part_description = PartDescription(part_name="test_part", brand="test_brand", price=100.0)
    ...
    def test_add_part_description(self):
        payload = {
            "part_name": "test_part",
            "brand": "test_brand",
            "price": 100.0
    ...
    def test_get_part_descriptions(self):
        ...
        self.assertEqual(response.json['items'][0]['part_name'], 'test_part')
