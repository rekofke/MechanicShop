...
from app.blueprints.part_description import part_description_bp as part_description_routes
...
def create_app(config_class='DevelopmentConfig'):
    ...
    app.register_blueprint(part_description_routes, url_prefix='/part-descriptions')
